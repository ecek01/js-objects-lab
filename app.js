...
const mewtwo = { number: 150, name: "Mewtwo", type: "psychic", hp: 106, starter: false };
const jolteon = { number: 135, name: "Jolteon", type: "electric", hp: 130, starter: false };
const lapras = { number: 131, name: "Lapras", type: "water", hp: 130, starter: false };

game.party.push(mewtwo, jolteon, lapras);
console.log(game.party);
...
const charmeleon = { number: 5, name: "Charmeleon", type: "fire", hp: 58, starter: false };

const charmanderIndex = game.party.findIndex(poke => poke.name === "Charmander");
